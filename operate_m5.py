    ...
    def update_keyboard(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_UP:
                self.command['motion'] = [2.3, -0.108]
            # drive backward
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_DOWN:
                self.command['motion'] = [-2.3, 0]
            # turn left
            ...
            #freeze the marker
                ...
                self.ekf.freeze = not(self.ekf.freeze)
            #self.efk.freeze = false here
            # save SLAM map
            ...
            # save object detection outputs
                ...
                print(f"[LEFT NEAR, RIGHT NEAR] = {self.pibot.get_ir()[1]}")
            # quit
...
from generateMap import get_gt_fruit_vec, a_star_algo, mesh_grid_plot
